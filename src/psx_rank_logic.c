...
PSX_MOD_CONSTRUCTOR(psx_rank_logic_install) {
    psx_rank_logic_register_menu();
    (void)psx_game_add_start_hook(psx_rank_logic_arm_sprite_watch);
    (void)psx_game_add_frame_hook(psx_rank_logic_tick);
}
