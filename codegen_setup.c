...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "YUGIOHFORBIDDENMEMORIESRECOMP_PROJECT_ROOT",
    .build_dir_env = "YUGIOHFORBIDDENMEMORIESRECOMP_BUILD_DIR",
    .force_setup_env = "YUGIOHFORBIDDENMEMORIESRECOMP_FORCE_SETUP",
